...
def ingeniero():
	...
	nombre=raw_input('Introduce el Nombre del Alimento>:')
	caloria=raw_input('Introduce las calorias de %s>:' %(nombre))
	proteina=raw_input('Introduce las proteinas de %s>:'%(nombre))
	carbohidratos=raw_input('Introduce los Carbohidratos de %s>:'%(nombre))
	grasa=raw_input('Introduce la grasa de %s>:'%(nombre))
	indiceglicemico=raw_input('Introduce el IndiceGlicemico de %s>:'%(nombre))
	print 'elije un tipo>:'
	...
	tipo=raw_input('Introduce las proteinas de %s>:'%(nombre))
...
def main():
	...
	if (conosco):
		...
		peso_new=raw_input('dime %s cuanto pesas ahora>:'%(conosco.nombre))
		print 'muy bien'
		...
		sexo=raw_input('Cual es tu sexo (hombre/mujer)>:')
